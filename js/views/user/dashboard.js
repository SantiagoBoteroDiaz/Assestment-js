import { totalTask, completeTask, pendingTask, progress, containerTask, userLog, URLTASK, logOut } from "../../doom.js"
let pending = 0;
let inProccess = 0
let Complete = 0;
export async function getTask() {
    ...
    try {
        const response = await fetch(`${URLTASK}?idUser=${userLog}`)
...
export function viewTask() {
    ...
    containerTask.addEventListener("click", updateTask); 
}